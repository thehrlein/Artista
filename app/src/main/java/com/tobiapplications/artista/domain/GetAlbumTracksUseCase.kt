...
class GetAlbumTracksUseCase constructor(private val networkManager: NetworkManagerDelegate) : BaseRequestUseCase<AlbumTracksRequestModel, AlbumTracksResponse>(){
